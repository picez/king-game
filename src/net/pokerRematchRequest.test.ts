...
const FINISHED = { phase: 'game_finished', stacksBySeat: [10000, 0], playerCount: 2, winnerSeat: 0, players: Array.from({ length: 2 }, (_, seat) => ({ id: 'p' + seat, name: 'P' + seat, seatIndex: seat, type: 'human' })) } as unknown as import('../games/poker/types').PokerState;
