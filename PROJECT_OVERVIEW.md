...
| **Poker** | 2–6 | No-Limit Texas Hold'em — 2 hole cards + 5 community, four betting streets, side/split pots, best-5-of-7, last-player-standing. **Bankroll economy (Stage 37.7):** chip wallet + daily claim, 8 online stakes (buy-in 100 BB) with optional blind growth, atomic escrow, human-only tables; local free-play has a configurable stack. Oval table UI + showdown review + hand-rankings help — [`POKER_RULES.md`](POKER_RULES.md) |
